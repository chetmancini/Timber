...
mongoCollection = pymongo.collection.Collection(
                    ...
                    config.MONGO_DB_LOG_COLLECTION)
if mongoCollection:
     debug("PyMongo: Database collection set up successfully.")
else:
     debug("PyMongo: Database collection initialization failed.")
